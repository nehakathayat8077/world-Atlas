...
const Home = () => {
  ...
  return (
    <div className='bg-gray-950 text-white min-h-screen  flex flex-col px-3 py-2 justify-center gap-10 md:gap-20 '>
     <div className='flex-row flex h-90 items-end justify-center'>
      ...
      <p className='text-sm text-gray-400 md:text-base'>Discover the history , culture , and beauuty of every nation. Sort , search and filter through the countries to find the details you need</p>
    ...
    <div className=' h-90 w-100 mt-10'>
